package fi.bizhop.kirves.security;

import fi.bizhop.kirves.Application;
...
public class JWTAuth {
    ...
    static {
        var jwtSecret = System.getenv("KIRVES_JWT_SECRET");
        if(jwtSecret == null) {
            LOG.error("Env KIRVES_JWT_SECRET must be set!");
            Application.exit();
        }
